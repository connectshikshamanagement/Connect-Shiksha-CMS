...
const checkGuestLectureProject = async () => {
  try {
    console.log('🔍 Checking Guest Lecture October project...');
    ...
    console.error('❌ Error checking Guest Lecture project:', err);
    process.exit(1);
  }
};

checkGuestLectureProject();
